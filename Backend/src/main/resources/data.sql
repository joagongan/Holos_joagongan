...
INSERT INTO works_done(id, artist_id, name, description, price, image) VALUES 
  ...
  (54, 26, 'Ocean Waves', 'A calming ocean scene with waves', 200.0, "/images/ocean_waves.jpg"), 
  (55, 27, 'Starry Night Replica', 'Inspired by Van Gogh’s Starry Night', 300.0, "/images/starry_night_replica.jpg"), 
  (56, 28, 'Abstract Art', 'A modern abstract composition', 180.0, "/images/abstract_art.jpg");
