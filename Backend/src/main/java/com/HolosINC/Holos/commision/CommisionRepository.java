...
public interface CommisionRepository extends JpaRepository<Commision, Long>{
    ...
    @Query("SELECT new com.HolosINC.Holos.commision.DTOs.CommissionDTO(c.id, c.name, c.description, c.price, c.status, c.paymentArrangement, c.milestoneDate, c.artist.baseUser.username, c.client.baseUser.username, c.image)" +
